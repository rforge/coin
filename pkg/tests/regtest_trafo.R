...
of_trafo(x, scores = cbind(s1 = 5:8, s2 = 9:12))
of_trafo(x[cc], scores = cbind(s1 = 5:8, s2 = 9:12))

of_trafo(ox)
of_trafo(ox[cc])
of_trafo(ox, scores = 5:8)
of_trafo(ox[cc], scores = 5:8)
of_trafo(ox, scores = cbind(s1 = 5:8, s2 = 9:12))
of_trafo(ox[cc], scores = cbind(s1 = 5:8, s2 = 9:12))
