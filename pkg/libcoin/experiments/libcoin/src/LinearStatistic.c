...
void C_CovarianceInfluence_weights(double* y, int N, int Q, int *weights, 
                                   ...
                                   double *QQ_ans) 
{
     C_KronSums_center_weights(y, N, Q, y, Q, weights, ExpInf, ExpInf, QQ_ans);
...
{
     C_KronSums_center_subset(y, N, Q, y, Q, subset, subset, Nsubset, 
...
void C_CovarianceInfluence_weights_subset(double* y, int N, int Q, int *weights, 
                                          ...
                                          double *QQ_ans) 
{
     C_KronSums_center_weights_subset(y, N, Q, y, Q, weights, subset, Nsubset, 
                                      ExpInf, ExpInf, QQ_ans);
     for (int q = 0; q < Q * Q; q++) QQ_ans[q] = QQ_ans[q] / sumweights;
}
