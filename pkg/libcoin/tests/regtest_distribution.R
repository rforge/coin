...
try(lc("independence_test",y ~ x | b, data = dta,
...
it <- lc("independence_test",y ~ x, data = dta,
                        distribution = exact(algo = "auto"))
it@distribution@name
pvalue(it)

try(lc("independence_test",y ~ x, data = dta,
                      distribution = exact(algo = "shift")))
...
### paired two-sample
try(lc("symmetry_test",y ~ x | b, data = dta2, paired = TRUE,
                  distribution = exact(algo = "auto")))
...
### two-sample with block
it <- lc("independence_test",y5 ~ x | b, data = dta,
...
try(lc("independence_test",y5 ~ x | b, data = dta,
                        distribution = exact(algo = "split-up")))

### two-sample without block
it <- lc("independence_test",y5 ~ x, data = dta,
                        distribution = exact(algo = "auto", fact = 1e5))
it@distribution@name
pvalue(it)
...
### paired two-sample
st <- lc("symmetry_test",y5 ~ x | b, data = dta2, paired = TRUE,
                    distribution = exact(algo = "auto", fact = 1e5))
...
try(lc("symmetry_test",y5 ~ x | b, data = dta2, paired = TRUE,
                  distribution = exact(algo = "split-up")))

### automatically mapped into integers

### two-sample with block
it <- lc("independence_test",y3 ~ x | b, data = dta,
                        distribution = exact(algo = "auto"))
it@distribution@name
pvalue(it)
...
try(lc("independence_test",y3 ~ x | b, data = dta,
                      distribution = exact(algo = "split-up")))

### two-sample without block
it <- lc("independence_test",y3 ~ x, data = dta,
                        distribution = exact(algo = "auto"))
it@distribution@name
pvalue(it)
...
### paired two-sample
st <- lc("symmetry_test",y3 ~ x | b, data = dta2, paired = TRUE,
                    distribution = exact(algo = "auto"))
st@distribution@name
pvalue(st)
...
try(lc("symmetry_test",y3 ~ x | b, data = dta2, paired = TRUE,
                  distribution = exact(algo = "split-up")))


### check exact tests with weights
itw1 <- lc("independence_test",y3 ~ x, data = dta, weights = ~ w,
                          distribution = exact(algorithm = "shift"))
itw2 <- lc("independence_test",y3 ~ x, data = dta, weights = ~ w,
                          distribution = exact(algorithm = "split-up"))
y3w <- with(dta, rep(y3, w))
xw <- with(dta, rep(x, w))
it1 <- lc("independence_test",y3w ~ xw, distribution = exact(algorithm = "shift"))
it2 <- lc("independence_test",y3w ~ xw, distribution = exact(algorithm = "split-up"))
...
itw1 <- lc("independence_test",as.table(Convictions), alternative = "less",
                          distribution = exact(algorithm = "shift"))
itw2 <- lc("independence_test",as.table(Convictions), alternative = "less",
                          distribution = exact(algorithm = "split-up"))
it1 <- lc("independence_test",Var2 ~ Var1, alternative = "less",
                         data = coin:::table2df(as.table(Convictions)),
                         distribution = exact(algorithm = "shift"))
it2 <- lc("independence_test",Var2 ~ Var1, alternative = "less",
                         data = coin:::table2df(as.table(Convictions)),
                         distribution = exact(algorithm = "split-up"))
stopifnot(isequal(pvalue(itw1), pvalue(it1)))
stopifnot(isequal(pvalue(itw1), pvalue(it2)))
...
### shift without block
it1_SR <- lc("independence_test",y ~ x, data = dta1,
                            distribution = exact(algorithm = "shift"))
...
it1_vdW <- lc("independence_test",y ~ x, data = dta1,
                             distribution = exact(algorithm = "split-up"))
...
### shift with block
it2_SR <- lc("independence_test",y ~ x | b, data = dta1,
                            distribution = exact(algorithm = "shift"))
...
st3_SR <- lc("symmetry_test",y ~ x | b, data = dta2,
                        distribution = exact(algorithm = "shift"),
                        paired = TRUE)
...
### shift with block
itq1 <- lc("independence_test",y ~ x | b, data = dta1,
                          distribution = exact(algorithm = "shift"),
                          teststat = "quad")
its1 <- lc("independence_test",y ~ x | b, data = dta1,
                          distribution = exact(algorithm = "shift"),
                          teststat = "scalar")
...
### paired shift with block
sts2 <- lc("symmetry_test",y ~ x | b, data = dta2,
                      distribution = exact(algorithm = "shift"),
                      paired = TRUE, teststat = "scalar")
stq2 <- lc("symmetry_test",y ~ x | b, data = dta2,
                      distribution = exact(algorithm = "shift"),
...
itq <- lc("independence_test",tab, distribution = exact(algorithm = "shift"),
                         teststat = "quad")
...
it_uas <- lc("independence_test",y1 ~ x,  data = dta,
...
it_uaq <- lc("independence_test",y1 ~ x,  data = dta,
...
it_mam <- lc("independence_test",y1 + y2 ~ x,  data = dta,
...
it_maq <- lc("independence_test",y1 + y2 ~ x,  data = dta,
                            distribution = "asymptotic", teststat = "quad")
...
it_ums <- lc("independence_test",y1 ~ x,  data = dta,
...
it_umq <- lc("independence_test",y1 ~ x,  data = dta,
...
it_mmm <- lc("independence_test",y1 + y2 ~ x,  data = dta,
...
it_mmq <- lc("independence_test",y1 + y2 ~ x,  data = dta,
                            distribution = "approximate", teststat = "quad")
...
it_ues <- lc("independence_test",y1 ~ x,  data = dta,
...
it_ueq <- lc("independence_test",y1 ~ x,  data = dta,
