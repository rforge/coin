...
\Rcmd{ytrafo} has to be set to the function \Rcmd{rank_trafo} for computing ranks, in \Rcmd{xtrafo}
...
<<alpha-kruskal, echo = TRUE>>=
independence_test(elevel ~ alength, data = alpha, ytrafo = rank_trafo, teststat = "quad")
@
