...
matrix $\Rb$ can be written as $\v (1/\v)^\top$ and it follows \citep[from][Section 2.1]{Meurant1992} 
that the
...
\end{eqnarray*}
Because of the special band structure of $\Rb^{-1}$ the quadratic form $\z^\top \Rb^{-1}\z$ 
simplifies to
\begin{eqnarray*}
