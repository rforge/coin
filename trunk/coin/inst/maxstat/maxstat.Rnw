...
residual leukemic cells in acute myeloid leukemia patients. 
%%The ability for
...
to extend the methodology to new areas of application. We do so by constructing
...
the standardized version of $\T_j$ and $Z^0(t_j)$ are asymptotically identical in distribution.
