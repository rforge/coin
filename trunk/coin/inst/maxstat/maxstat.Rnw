...
generalized class of maximally selected statstics that contains the tests
...
of the conditional asymptotic distribution: A new linear-time algorithm is proposed
...
as influence function $h$ for the censored response and the potential paritions
