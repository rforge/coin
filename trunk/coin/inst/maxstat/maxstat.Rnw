...
a similar approach, obtaining a threshold for residual leukemic cells in AML 
...
statistics is derived. Furthermore, our new conditional formulation of maximally selected
