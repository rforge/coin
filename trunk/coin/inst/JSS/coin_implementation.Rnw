...
### pretty printing
toLatex.c2t <- function(object, ...) {        

    RET <- c("\\\\", "\\begin{tabular}{ll}",
             paste("\\multicolumn{2}{l}{Class: \\Rclass{", attr(object, "name"), "}} \\\\", sep = ""),
             "Slot & Type \\\\ \\hline \\hline",
...
All tests are based on objects of class \Rclass{IndependenceTest}:
