...
standardized by conditional expectation and variance, and aggregated to
...
the paper with a short discussion, some more details about the underlying theory
...
and income can be rejected in favor of a linear dependency of both variables.
