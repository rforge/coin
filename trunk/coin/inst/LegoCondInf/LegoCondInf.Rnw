...
\marginpar{FIXME \\ Approximations?}
\newline
...
the \Rcmd{numeric\_trafo} argument to the \Rcmd{trafo} function which handles
...
contincency table can be obtained from the $16$-dimensional
...
when $p$-values are computed \citep{numerical-:1992}.
