...
\bibitem[{Balkin and Mallows(2001)}]{BalkinMallows2001}
...
\bibitem[{Berger(2000)}]{pros-and-c:2000}
Berger, V.~W. (2000), \enquote{Pros and Cons of Permutation Tests in Clinical
  Trials,} \textit{Statistics in Medicine}, 19, 1319--1328.

\bibitem[{B{\"o}nsch et~al.(2005)B{\"o}nsch, Lederer, Reulbach, Hothorn,
  Kornhuber, and Bleich}]{Boenscheta2005}
...
\bibitem[{Edgington(1987)}]{Edgington1987}
...
\bibitem[{Genz(1992)}]{numerical-:1992}
...
\bibitem[{Ludbrook and Dudley(1998)}]{why-permut:1998}
...
\bibitem[{Molefe et~al.(2005)Molefe, Chen, Howard, Miller, Sambuco, Forbes, and
  Kodell}]{Molefeetal2005}
...
\bibitem[{Shuster(2005)}]{Shuster2005}
...
\bibitem[{Strasser and Weber(1999)}]{StrasserWeber1999}
